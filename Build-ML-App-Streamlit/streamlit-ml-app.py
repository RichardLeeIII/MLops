...
def main():
    ...
    ApplicantIncome = st.number_input("Applicant Income(USD)")
    CoapplicantIncome = st.number_input("Coapplicant Income(USD)")
    LoanAmount = st.number_input("LoanAmount(USD)")
    Loan_Amount_Term = st.number_input("Loan Amount Term(Number of Months)")
