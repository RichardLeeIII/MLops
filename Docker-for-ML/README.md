...
docker ps shows all the container currently running
docker ps -a
docker run -it busybox sh create container instance
...
docker login
docker build -t richardleeiii/catgif-devops .
docker push richardleeiii/catgif-devops
```
