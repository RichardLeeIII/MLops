...
`mlflow models serve -m /C:/Users/WhiyongL/Desktop/MLOPs%20practice/MLflow/mlruns/572264926233920912/f6f1cb3610fd4f2b90735bfe0e0b5bf7/artifacts/RandomForestClassifier --port 9000 --no-conda`
...
curl --location 'http://localhost:9000/invocations' \
...
`mlflow models serve -m "models:/Prediction_Model_RF/1" -p 1234 --no-conda`

`stage depreciated, put version number after model name`
